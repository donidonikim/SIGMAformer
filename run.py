...
# basic config
parser.add_argument('--task_name', type=str, required=True, help='Task name, e.g., long_term_forecast')
parser.add_argument('--is_training', type=int, required=True, help='Training status: 1 for training, 0 for testing')
parser.add_argument('--model_id', type=str, required=True, help='Model ID')
parser.add_argument('--model', type=str, required=True, choices=['Corrformer', 'TimeMixer', 'iTransformer', 'SIGMAformer'], help='Model name')

# data loader
parser.add_argument('--data', type=str, required=True, choices=['Global_Wind', 'Global_Temp'], help='Dataset name')
...
parser.add_argument('--node_num', type=int, default=3850, help='number of nodes')
...
parser.add_argument('--patience', type=int, default=1, help='early stopping patience') #기존 3
...
parser.add_argument('--gpu', type=int, default=0, help='GPU index for single GPU use')
parser.add_argument('--use_multi_gpu', type=bool, default=False, help='use multiple GPUs')
parser.add_argument('--devices', type=str, default='0', help='Comma-separated list of GPU device IDs')

# Argument parsing
args = parser.parse_args()

if args.root_path is None:
    if args.data == 'Global_Wind':
        args.root_path = './dataset/global_wind/'
    elif args.data == 'Global_Temp':
        args.root_path = './dataset/global_temp/'
